...
$db['staging']['username'] = 'triptogo_admin';
$db['staging']['password'] = '1234qwer';
$db['staging']['database'] = 'triptogo_trip2go';
...
$db['prod']['username'] = 'triptogo_admin';
$db['prod']['password'] = '1234qwer';
$db['prod']['database'] = 'triptogo_trip2go';
